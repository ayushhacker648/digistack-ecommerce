        ...
        <div className='bg-white py-3 shadow-2xl px-4 md:px-0'>
            <div className='max-w-6xl mx-auto flex justify-between items-center'>
                ...
                <div className='flex gap-7 items-center'>
                    <Link to={'/'}><h1 className='font-bold text-3xl'><span className='text-red-500 font-serif'>D</span>igiStack</h1></Link>
                ...
                <nav className='flex gap-7 items-center'>
                    ...
                    <div className='hidden md:block'>
                        <SignedOut>
                            <SignInButton className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 text-sm rounded-full shadow-sm font-medium transition duration-300 cursor-pointer" />
                        </SignedOut>
                        <SignedIn>
                            <UserButton />
                        </SignedIn>
